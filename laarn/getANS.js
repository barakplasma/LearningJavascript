...
function checkNS(err, ns) {
  ...
  if (err !== null) {
    ...
    let nsCheck = '';
    nsRegex.test(ns[0])? nsCheck = 'correctly set. ' : nsCheck = 'not correctly set. ';
...
function checkCNAME(err,cname){
  ...
  if (err !== null) {
    ...
    let cnameCheck = '';
    cnameRegex.test(cname[0])? cnameCheck = 'correctly set. ' : cnameCheck = 'not correctly set. ';
